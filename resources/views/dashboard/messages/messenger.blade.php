@extends('layouts.app', ['body_class' => 'with-side-menu control-panel control-panel-compact'],['container_class' => 'messenger'])

@push('styles')
    <link rel="stylesheet" href="{{ asset('css/custom/chat.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom/messenger.min.css') }}">
@endpush
                ...
                <div class="chat-dialog-area scrollable-block">
                    <div class="messenger-dialog-area">
                        <div class="messenger-message-container">
                            <div class="avatar">
                                <img src="{{asset('img/avatar-1-32.png')}}">
                            </div>
                            <div class="messages">
                                <ul>
                                    <li>
                        ...
                        <div class="messenger-message-container from bg-blue">
                            ...
                            <div class="avatar chat-list-item-photo">
                                <img src="{{asset('img/photo-64-1.jpg')}}">
                            </div>
                        </div>
                        <div class="messenger-message-container">
                            <div class="avatar">
