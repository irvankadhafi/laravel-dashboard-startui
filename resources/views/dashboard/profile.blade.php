...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/custom/slick.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom/profile.min.css') }}">
@endpush
            ...
            <section class="box-typical">
                <div class="profile-card">
                    <div class="profile-card-photo">
                        <img src="{{asset('img/photo-220-1.jpg')}}" alt=""/>
                    </div>
                ...
                <div class="posts-slider">
                    <div class="slide">
                        <article class="post-announce">
                            <div class="post-announce-pic">
                                <a href="#">
                                    <img src="{{asset('img/post-1.jpeg')}}" alt="">
                                </a>
                            </div>
                    ...
                    <div class="slide">
                        <article class="post-announce">
                            <div class="post-announce-pic">
                                <a href="#">
                                    <img src="{{asset('img/post-3.jpeg')}}" alt="">
                                </a>
                            </div>
                            <div class="post-announce-title">
                ...
                <article class="profile-info-item">
                    ...
                    <section class="skill-item tbl">
                        <div class="tbl-row">
                            ...
                            <div class="tbl-cell tbl-cell-users">
                                <img class="skill-user-photo" src="{{asset('img/avatar-1-64.png')}}" alt=""/>
                                <img class="skill-user-photo" src="{{asset('img/photo-64-3.jpg')}}" alt=""/>
                                <img class="skill-user-photo" src="{{asset('img/photo-64-4.jpg')}}" alt=""/>
                    ...
                    <section class="skill-item tbl">
                        <div class="tbl-row">
                            ...
                            <div class="tbl-cell tbl-cell-users">
                                <img class="skill-user-photo" src="{{asset('img/avatar-2-64.png')}}" alt=""/>
                                <img class="skill-user-photo" src="{{asset('img/photo-64-2.jpg')}}" alt=""/>
                                <img class="skill-user-photo" src="{{asset('img/photo-64-3.jpg')}}" alt=""/>
                    ...
                    <section class="skill-item tbl">
                        <div class="tbl-row">
                            ...
                            <div class="tbl-cell tbl-cell-users">
                                <img class="skill-user-photo" src="{{asset('img/avatar-3-64.png')}}" alt=""/>
                                <img class="skill-user-photo" src="{{asset('img/photo-64-1.jpg')}}" alt=""/>
                                <img class="skill-user-photo" src="{{asset('img/photo-64-2.jpg')}}" alt=""/>
                        ...
                        <div class="col">
                            <article class="follow-group">
                                <div class="follow-group-logo">
                                    <a href="#" class="follow-group-logo-in"><img src="{{asset('img/logo-2.png')}}" alt=""></a>
                                </div>
                ...
                <section>
                    ...
                    <div class="profile-card-slider">
                        ...
                        <div class="slide">
                            <div class="profile-card">
                                <div class="profile-card-photo">
                                    <img src="{{asset('img/avatar-2-256.png')}}" alt=""/>
                                </div>
                                <div class="profile-card-name">Sarah Sanchez</div>
                        ...
                        <div class="slide">
                            <div class="profile-card">
                                <div class="profile-card-photo">
                                    <img src="{{asset('img/avatar-3-256.png')}}" alt=""/>
                                </div>
                                <div class="profile-card-name">Sarah Sanchez</div>
                                <div class="profile-card-status">Longnameexample<br/>corporation</div>
                                <button type="button" class="btn btn-rounded btn-primary-outline">Follow</button>
            ...
            <section class="box-typical">
                ...
                <div class="people-rel-list">
                    ...
                    <ul class="people-rel-list-photos">
                        <li><a href="#"><img src="{{asset('img/photo-92-1.jpg')}}" alt=""></a></li>
                        <li><a href="#"><img src="{{asset('img/photo-92-2.jpg')}}" alt=""></a></li>
                        <li><a href="#"><img src="{{asset('img/photo-92-3.jpg')}}" alt=""></a></li>
                        <li><a href="#"><img src="{{asset('img/avatar-1-128.png')}}" alt=""></a></li>
                        <li><a href="#"><img src="{{asset('img/photo-92-2.jpg')}}" alt=""></a></li>
                        <li><a href="#"><img src="{{asset('img/avatar-2-128.png')}}" alt=""></a></li>
                        <li><a href="#"><img src="{{asset('img/photo-92-1.jpg')}}" alt=""></a></li>
                        <li><a href="#"><img src="{{asset('img/avatar-3-128.png')}}" alt=""></a></li>
                        <li><a href="#"><img src="{{asset('img/photo-92-3.jpg')}}" alt=""></a></li>
                        <li><a href="#"><img src="{{asset('img/photo-92-1.jpg')}}" alt=""></a></li>
                        <li><a href="#"><img src="{{asset('img/photo-92-2.jpg')}}" alt=""></a></li>
                        <li><a href="#"><img src="{{asset('img/photo-92-3.jpg')}}" alt=""></a></li>
