...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/custom/summernote.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom/editor.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom/mail.min.css') }}">
    ...
    <section class="box-typical mail-box">
        ...
        <section class="mail-box-list  scrollable-block">
            ...
            <div class="mail-box-item">
                <div class="mail-box-item-header">
                    <div class="mail-box-item-photo">
                        <img src="{{asset('img/avatar-3-64.png')}}" alt="">
                    </div>
                    <div class="tbl mail-box-item-head-tbl">
                        <div class="tbl-row">
                            <div class="tbl-cell">
...
@push('scripts')
    <script src="{{ asset('js/custom/summernote.min.js') }}"></script>
    <script>
